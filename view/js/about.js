...
window.NPTI_DB = {
    ...
    guides: [
        { code: "LTFP", name: "\"따뜻한 장문 탐독가\"", desc: "행간의 이야기 속에서 따뜻한 사실을 찾는 독자.", pref: "스토리 중심으로 몰입할 수 있는 희망적인 기사 선호." },
        { code: "LTFN", name: "\"현실 통찰 독서가\"", desc: "현실을 통찰하는 긴 스토리텔링에 사회의 어두운 실상을 깊게 파고드는 독자.", pref: "문제의 구조와 원인을 낱낱이 파헤치는 기사 선호." },
        { code: "LTIP", name: "\"낙관적 사유가\"", desc: "낙관적 서사를 통해 세상과 교류를 찾는 독자.", pref: "긴 서사 속에서 의미와 성찰을 발견할 수 있는 기사 선호." },
        { code: "LTIN", name: "\"구조 해부 사상가\"", desc: "구조적 해부와 분석을 통해 복잡한 문제를 이해하려는 독자.", pref: "이야기 속 원인과 구조를 깊게 분석하는 기사 선호." },
        { code: "LCFP", name: "\"밝은 정보 협독가\"", desc: "유쾌한 정보와 팩트를 통해 세상을 넓게 이해하려는 독자.", pref: "밝은 정보 기사에서 차분한 설명을 제공하는 기사 선호." },
        { code: "LCFN", name: "\"팩트 정밀 감시자\"", desc: "팩트와 근거를 통해 사회 문제의 구조를 파악하려는 독자.", pref: "정보 위주의 심층 기사로 맥락을 설명하는 기사 선호." },
        { code: "LCIP", name: "\"짧은 전망 분석가\"", desc: "정보를 기반으로 전망과 데이터에 진심을 두는 독자.", pref: "짧은 기사에서 미래의 가치와 의미를 제시하는 기사 선호." },
        { code: "LCIN", name: "\"리스크 구조 분석가\"", desc: "리스크와 구조를 구조적으로 분석하려는 독자.", pref: "문제를 냉철하게 해부하는 정보 중심 기사 선호." },
        { code: "STFP", name: "\"힐링 스토리 리더\"", desc: "짧은 이야기 속에서 따뜻한 삶을 찾는 독자.", pref: "읽을 때 가볍게 기분 좋아지는 기사 선호." },
        ...
        { code: "SCFP", name: "\"속도형 정보 소비자\"", desc: "빠르게 정보를 확인하며 긍정적인 흐름을 읽고 싶어 하는 독자.", pref: "속도감 있는 정보 기사 중 밝은 톤의 기사 선호." },
        { code: "SCFN", name: "\"경계심 강한 체커\"", desc: "빠른 정보 속에서 사건의 구조와 맥락을 파악하려는 독자.", pref: "경제·사회 이슈를 간결하게 정리한 기사 선호." },
        { code: "SCIP", name: "\"빠른 인사이트 수집가\"", desc: "짧은 기사라도 인사이트를 얻고 싶어 하는 독자.", pref: "핵심 요약이 명확한 요약형 기사 선호." },
